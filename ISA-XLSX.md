...
The `Run` represents the application of a computational workflow. A `Run File` contains metadata about the executed workflows, information about the people creating, picking and parametrizing these workflow exections, and most importantly, details about the input data, parametrization and the result data.
...
Any Run MAY contain datamap references as described in the [`Datamap Sheet`](#datamap-table-sheets) section.
...
| Run File Name           | String     | A field to specify the name of the Run Table file corresponding the definition of that assay. There can be only one file per cell. |
...
| Label | Datatype | Description |
|-------|----------|-------------|
| Run Person Last Name | String  | The last name of a person associated with the Assay.  |
| Run Person First Name  | String | Run Person Name |
| Run Person Mid Initials  | String  | The middle initials of a person associated with the Assay.|
| Run Person Email | String formatted as email | The email address of a person associated with the Assay. |
| Run Person Phone  | String | The telephone number of a person associated with the Assay. |
| Run Person Fax  | String | The fax number of a person associated with the assay.  |
| Run Person Address  | String | The address of a person associated with the assay. |
| Run Person Affiliation | String | The organization affiliation for a person associated with the assay. |
